...
// writes the fixed phase anchor and returns the new anchor in the response, AND
// resets the in-progress weekly Token usage to 0 (re-anchoring opens a fresh
// 7-day window; see the 2026-07-23 苏卓雄 carry-over bug).
